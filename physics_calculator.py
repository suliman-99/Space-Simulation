...
def calc_friction(pos1: Vector, pos2: Vector, velocity1: Vector, velocity2: Vector, force1: Vector, force2: Vector,
                  friction_coefficient1: float, friction_coefficient2: float) -> tuple[Vector, Vector]:
    un = (pos2 - pos1).norm()
