...
class Controls:
    ...
    def on_saved(self):
        save_as(self.environment.planets_array, self.environment.time_scale, 'saved_state')

    def on_cheked(self, value):
        self.environment.set_trail_state(value.checked)

    def restart_demo(self):
        self.environment.restart_environment()
    ...
    def render(self):
        ...
        checkbox(bind=self.on_cheked, text='Show Trail', checked=False)
